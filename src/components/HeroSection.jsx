  ...
  return (
    <div className='text-center'>
      <div className='flex flex-col gap-5 my-10'>
        ...
        <form onSubmit={handleSearch} className='flex w-[40%] shadow-lg border border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto'>
          <Input
            type="text"
            placeholder="Find your next role by job title"
            className="outline-none border-none w-full"
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
          />
          <Button type="submit" className='rounded-r-full bg-[#6A38C2] hover:bg-[#5b30a6]'>
